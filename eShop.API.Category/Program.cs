...
//it is a webapplication builder, each API has its builder, builder determine how Api shows the function
...
// SQL Server Service Registration //how to talk with db 
...
/**********
 ** CORS Cross-Origin Resource Sharing** //to allow other https and web applications to use our application
 **********/
...
{
    ConfigureAutoMapper();
    builder.Services.AddScoped<IDbService, CategoryDbService>(); //scoped is a role how long automaticly new instace can live until convert to dto and then will die
}

void ConfigureAutoMapper() //createmap can convert entities (category properties) to dto, Reversemap: convert dto to entities
{
